...
urlpatterns = [
    ...
    path('', include(router.urls)),
        # URLs para CRUD de salas
    path('salas/crear/', views_crud.crear_sala, name='crear_sala'),
    path('salas/', views_crud.lista_salas, name='lista_salas'),
    ...
    # Consultas
path('crud/consultas/crear/', views.crear_consulta, name='crear_consulta'),
path('crud/consultas/editar/<int:id>/', views.editar_consulta, name='editar_consulta'),
path('crud/consultas/eliminar/<int:id>/', views.eliminar_consulta, name='eliminar_consulta'),
path('crud/consultas/', views.lista_consultas, name='crud_consultas'),

# Tratamientos
path('crud/tratamientos/crear/', views.crear_tratamiento, name='crear_tratamiento'),
path('crud/tratamientos/editar/<int:id>/', views.editar_tratamiento, name='editar_tratamiento'),
path('crud/tratamientos/eliminar/<int:id>/', views.eliminar_tratamiento, name='eliminar_tratamiento'),
path('crud/tratamientos/', views.lista_tratamientos, name='crud_tratamientos'),

# Salas
path('crud/salas/crear/', views.crear_sala, name='crear_sala'),
path('crud/salas/editar/<int:id>/', views.editar_sala, name='editar_sala'),
path('crud/salas/eliminar/<int:id>/', views.eliminar_sala, name='eliminar_sala'),
path('crud/salas/', views.lista_salas, name='crud_salas'),
]