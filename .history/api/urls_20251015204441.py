...
# Agrega estas líneas a tu urlpatterns:
    ...
    path('especialidades/', views.EspecialidadViewSet.as_view({'get': 'list'}), name='especialidades-list'),
    ...
    path('especialidades/editar/<int:id>/', views.editar_especialidad, name='editar_especialidad'),  # ← AGREGAR ESTA LÍNEA
