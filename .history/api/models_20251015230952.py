...
class Especialidad(models.Model):
    ...
    descripcion = models.TextField(blank=True, default='')  # ← ESTE CAMPO DEBE EXISTIR
...
class Tratamiento(models.Model):
    ...
    fecha_inicio = models.DateField(auto_now_add=True)  # Agregar este campo
    fecha_fin = models.DateField(null=True, blank=True)  # Agregar este campo
    descripcion = models.TextField(blank=True)  # Agregar este campo
    
    def __str__(self):
        return f"Tratamiento {self.id} - {self.paciente}"
...
class Receta(models.Model):
    ...
    def __str__(self):
        return f"Receta para {self.paciente} - {self.medico.nombre}"
