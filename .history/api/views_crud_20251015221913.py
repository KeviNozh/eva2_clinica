...
def editar_tratamiento(request, id):
    """Vista para editar tratamiento - CON CREACIÓN DE MEDICAMENTOS SI NO EXISTEN"""
    try:
        # Obtener el tratamiento
        tratamiento = Tratamiento.objects.get(id=id)
        
        # OBTENER LOS MEDICAMENTOS - CON CREACIÓN AUTOMÁTICA
        medicamentos = Medicamento.objects.all()
        
        # SI NO HAY MEDICAMENTOS, CREAR ALGUNOS DE PRUEBA
        ...
        # PASAR MEDICAMENTOS AL TEMPLATE
        context = {
            'tratamiento': tratamiento,
            'consultas': consultas,
            'medicamentos': medicamentos
