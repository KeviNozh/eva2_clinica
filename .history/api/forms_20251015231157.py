...
class TratamientoForm(forms.ModelForm):
    class Meta:
        model = Tratamiento
        fields = ['paciente', 'medico', 'diagnostico', 'medicamentos', 'instrucciones']
        # Solo incluye campos que realmente existan en tu modelo Tratamiento
        widgets = {
...
class RecetaForm(forms.ModelForm):
    class Meta:
        model = Receta
        fields = ['medico', 'paciente', 'medicamentos', 'indicaciones']
        # Solo incluye campos que realmente existen en tu modelo Receta
